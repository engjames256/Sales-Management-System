function sales() {
  ...
  var customerId = document.salesForm.customerId.value;
  var name = document.salesForm.name.value;
  var town = document.salesForm.town.value;
  var partNumber = document.salesForm.partNumber.value;
  var description = document.salesForm.description.value;
  var pricePerPart = document.salesForm.pricePerPart.value;
  var quantity = document.salesForm.quantity.value;
